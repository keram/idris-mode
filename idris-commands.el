...
(defun idris-quit ()
  ...
  (interactive)
  (when (get-buffer-process idris-process-buffer-name)
    (delete-process idris-process-buffer-name))
  (when (get-buffer-process idris-connection-buffer-name)
    (delete-process idris-connection-buffer-name))
  (when (get-buffer idris-process-buffer-name)
    (kill-buffer idris-process-buffer-name))
  (when (get-buffer idris-connection-buffer-name)
